...
function DashboardActionCard({
  ...
  return (
    <Link
      href={href}
      className="flex h-full min-h-0 flex-col justify-center rounded-xl border border-slate-200 bg-slate-50 p-5 transition hover:-translate-y-0.5 hover:bg-white hover:shadow-sm"
    >
      ...
      <main className="min-h-screen bg-slate-100 text-slate-900">
        ...
        <section className="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8 lg:py-10">
          ...
          <div className="grid gap-6 lg:grid-cols-2">
            <div className="grid grid-rows-[240px_auto] gap-6">
              <section className="grid h-60 gap-4 rounded-xl bg-white p-6 shadow-sm">
                <DashboardActionCard
                  href="/import"
                  title="Import Single Activity"
                  description="Upload single PNG or PDF activity file and add searchable metadata."
                />

                <DashboardActionCard
                  href="/import/bulk"
                  title="Upload Bulk Activities"
                  description="Upload multiple PNG or PDF activities with .csv file."
                />
              </section>
