...
export default function MyActivitiesClient() {
  ...
  async function handleSaveMetadata() {
    if (!selectedActivity || !metadataDraft || isSavingMetadata) return;
                ...
                <>
                  ...
                  <div className="mt-5 flex justify-end">
                    <button
                      ...
                      className="rounded-lg bg-[#0d2140] px-4 py-2 text-sm font-semibold text-white transition hover:bg-[#17345f] disabled:cursor-not-allowed disabled:opacity-60"
                    >
